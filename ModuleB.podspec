...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/yymodularization/ModuleB"
  ...
  s.source       = { :git => "https://github.com/yymodularization/ModuleB.git", :tag => s.version.to_s }
  ...
  s.source_files  = "ModuleB/ModuleB/**/*.{h,m,swift}"
